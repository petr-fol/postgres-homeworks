...
SELECT ship_country FROM orders WHERE ship_country IN ('France', 'Germany', 'Spain');
...
SELECT AVG(DATEDIFF(shipped_date, order_date)) FROM orders WHERE ship_country = 'Germany';
