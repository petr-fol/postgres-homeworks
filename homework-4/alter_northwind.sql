...
ALTER  TABLE products
ADD CONSTRAINT discontinued_value CHECK (discontinued IN (0, 1));
...
DROP CONSTRAINT order_details_products_fk;
-- Удаление товаров из products, снятых с продажи
DELETE FROM products WHERE discontinued = 1;
-- Восстановление foreign key constraint
ALTER TABLE order_details
